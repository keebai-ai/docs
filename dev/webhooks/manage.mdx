...
**Response 200** — same shape as `create`, with a new `secret`. **The old one is invalidated immediately.** For zero-downtime rotation, see [security](/dev/webhooks/security#rotación-de-secret).
