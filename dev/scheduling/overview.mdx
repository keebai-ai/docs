...
Every endpoint on this page is also an [MCP tool](/dev/mcp/tools#scheduling), so an AI agent can check availability and book with the same token and scopes.
