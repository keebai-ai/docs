...
- **Archiving does not detach.** Agents referencing the block keep using it, and its content keeps rendering into their prompts. [Detach it](/dev/endpoints/agents-block-detach) if that is what you meant.
