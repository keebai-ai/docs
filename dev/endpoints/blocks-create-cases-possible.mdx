...
Situations that can come up and how to answer each one. Unlike [steps](/dev/endpoints/blocks-create-steps), these have no order between them — the assistant matches whichever applies.
