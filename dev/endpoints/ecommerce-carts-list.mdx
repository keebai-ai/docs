...
- **`recovery_url` is the whole point.** It drops the customer back into checkout with the cart intact. Pairing it with [`POST /v1/messages/interactive/cta-url`](/dev/endpoints/messages-interactive-cta-url) is the intended recovery flow.
