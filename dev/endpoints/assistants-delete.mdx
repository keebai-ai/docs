---
title: "DELETE /v1/assistants/{id}"
sidebarTitle: "DELETE assistants/:id"
description: "Delete an assistant permanently. Its blocks survive and stay in the project catalogue."
openapi: "DELETE /v1/assistants/{id}"
---
