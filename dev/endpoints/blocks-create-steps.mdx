---
title: "POST /v1/blocks/steps"
sidebarTitle: "POST blocks/steps"
description: "Create a steps block with its content as plain text."
openapi: "POST /v1/blocks/steps"
---

The procedure the agent follows, in order. Use it when the conversation has a shape: gather, confirm, act.
...
<Note>
  **Instruction block: an agent can hold several.** Split long procedures into named blocks rather than one giant one — they are easier to reorder and to reuse.
</Note>
