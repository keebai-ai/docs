---
title: "PUT /v1/functions/{id}"
sidebarTitle: "PUT functions/:id"
description: "Update a webhook function. Omitting headers keeps the stored ones; sending them replaces the whole map."
openapi: "PUT /v1/functions/{id}"
---
