...
Read and write the configuration of the agents themselves: their goal, the [sections of their prompt](/dev/agents/configuration), the funnel, and the webhook tools they can call. Twenty-four tools, all on `agents:read` or `agents:write`.
