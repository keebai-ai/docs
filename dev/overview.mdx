...
The Keebai public API connects your CRM, your own backend, automations (Zapier, n8n, Make), or any internal tool to your WhatsApp channels and agents. Direct, scriptable access — no portal required.
...
<CardGroup cols={2}>
  ...
  <Card title="Agents" icon="robot" href="/dev/agents/overview">
    Create agents, write the blocks that make up their prompt, and give them webhooks to call.
  </Card>
  <Card title="MCP server" icon="plug-circle-bolt" href="/dev/mcp/overview">
    Give an AI agent the same API as 104 tools, with the same token and scopes.
  </Card>
</CardGroup>
