...
| `agents:read` | agents | [List agents](/dev/endpoints/agents-list), [read the blocks that make up their prompt](/dev/endpoints/agents-blocks-list), [read block content](/dev/endpoints/blocks-content-get) and [version history](/dev/endpoints/blocks-versions-list), and [list webhook functions](/dev/endpoints/functions-list). |
| `agents:write` | agents | [Create](/dev/endpoints/agents-create) and [configure agents](/dev/endpoints/agents-update), [create](/dev/endpoints/blocks-create-personification) and [edit prompt blocks](/dev/endpoints/blocks-content-save), and [manage the webhook functions](/dev/endpoints/functions-create) they can call. |
